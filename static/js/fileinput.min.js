        ...
        constructor: i, _cleanup: function () {
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                var T, E, S, k, F, P, I, A, D, z, $, j, U = v + x, B = u + "-" + U, R = i[x], O = m.text, L = m.image,
                    Z = m.html, M = R && R.name ? r.slug(R.name) : "", N = (R && R.size || 0) / 1e3, H = "",
                    V = R ? t.objUrl.createObjectURL(R) : null, W = 0, q = "", K = 0, G = function () {
                ...
                if (R) {
                    ...
                    if (!t.isEmpty(g) && t.isArray(g)) {
                        ...
                        if (0 === W) return S = r.msgInvalidFileType.setTokens({name: M, types: q}), void y(S, R, B, x)
                    }
                    ...
                    o.length && void 0 !== FileReader ? (D = O(R.type, M), z = Z(R.type, M), $ = L(R.type, M), d.html(c.replace("{index}", x + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                        ...
                        if (n = {name: M, type: R.type}, e.each(m, function (e, t) {
